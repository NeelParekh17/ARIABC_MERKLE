...
# Accessible PG nodes: 10.129.27.54 + 10.129.148.236 (truly distributed).
...
BASE_LOG="$ROOT/scripts/bench_full_results/overhead_3node_${RUN_TS}"
mkdir -p "$BASE_LOG"

echo "=== 4-profile overhead benchmark (3-node distributed) ==="
echo "Nodes: 248 (neel), 27.54 (neel), 236 (neel)"
...
# Sync latest bench script to gateway before each run
sync_scripts() {
